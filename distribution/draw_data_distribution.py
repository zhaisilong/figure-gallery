...
plt.title("Distribution of PBDD energy gap", fontsize=30, pad=20)
plt.tick_params(labelsize=25)
plt.xlabel("E_gap (eV)", fontsize=35, labelpad=20)
plt.ylabel("Distribution", fontsize=35, labelpad=25)
plt.savefig('out/Distribution.png', dpi=250)
plt.show()
# import numpy as np
# import seaborn as sns
# from matplotlib import pyplot as plt
